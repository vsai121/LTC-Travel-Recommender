...
results=[]
coordinates=[]
key="AIzaSyBPixfCdBcIm0ro9AXK0zT1HnesX5R7Wh8"
geocode_keys=[]
distance_keys=[]
...
def loadDistances(place1, place2):
	try:
		result = requests.get('https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins=' + place1 + '&destinations=' + place2+'&key='+key)
